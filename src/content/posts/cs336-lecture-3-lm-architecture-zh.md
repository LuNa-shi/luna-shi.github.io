---
title: CS336：第 3 讲 LM 架构与超参数
date: '2026-05-22'
overview: TLDR：现代 LM 架构是一组工程权衡：归一化、激活函数、注意力、位置编码、超参数、稳定性和推理成本会互相牵制。
description: TLDR：现代 LM 架构是一组工程权衡：归一化、激活函数、注意力、位置编码、超参数、稳定性和推理成本会互相牵制。
math: true
toc: true
relatedPosts: true
tags:
...
categories:
 ...
 - systems
lang: zh
translationKey: cs336-lecture-3-lm-architecture
canonicalSlug: cs336-lecture-3-lm-architecture
---
