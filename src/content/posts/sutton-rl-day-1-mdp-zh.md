---
title: Sutton RL：第 1 天 - RL 问题和 MDP 基础知识
date: '2026-05-27'
overview: TLDR：RL 是长期奖励的交互：政策选择行动，奖励提供反馈，价值估计未来回报，贝尔曼方程将各个部分连接起来。
description: TLDR：RL 是长期奖励的交互：政策选择行动，奖励提供反馈，价值估计未来回报，贝尔曼方程将各个部分连接起来。
math: true
toc: true
relatedPosts: true
tags:
...
categories:
 - learning
lang: zh
translationKey: sutton-rl-day-1-mdp
canonicalSlug: sutton-rl-day-1-mdp
---
