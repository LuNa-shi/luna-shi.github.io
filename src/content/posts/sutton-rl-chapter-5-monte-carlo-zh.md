---
title: Sutton RL：第 5 章 - 蒙特卡罗方法
date: '2026-05-29'
overview: TLDR：蒙特卡罗方法从完整的采样片段中学习价值，用无模型的简单性来换取延迟更新和返回方差。
description: TLDR：蒙特卡罗方法从完整的采样片段中学习价值，用无模型的简单性来换取延迟更新和返回方差。
math: true
toc: true
relatedPosts: true
tags:
...
categories:
 - learning
lang: zh
translationKey: sutton-rl-chapter-5-monte-carlo
canonicalSlug: sutton-rl-chapter-5-monte-carlo
---
