---
title: Sutton RL：第 2 天 多臂老虎机
date: '2026-05-28'
overview: TLDR：多臂老虎机通过消除状态转换并将动作价值估计作为中心来隔离探索/利用问题。
description: TLDR：多臂老虎机通过消除状态转换并将动作价值估计作为中心来隔离探索/利用问题。
math: true
toc: true
relatedPosts: true
tags:
...
categories:
 - learning
lang: zh
translationKey: sutton-rl-day-2-bandits
canonicalSlug: sutton-rl-day-2-bandits
---
