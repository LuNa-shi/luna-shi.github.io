---
title: CS336：第 4 讲 Mixture of Experts
date: '2026-05-22'
overview: TLDR：MoE 通过稀疏专家路由扩大参数量，但真正的难点是平衡 token 负载、容量、通信成本和专家分工。
description: TLDR：MoE 通过稀疏专家路由扩大参数量，但真正的难点是平衡 token 负载、容量、通信成本和专家分工。
math: true
toc: true
relatedPosts: true
tags:
...
categories:
 ...
 - systems
lang: zh
translationKey: cs336-lecture-4-moe
canonicalSlug: cs336-lecture-4-moe
---
