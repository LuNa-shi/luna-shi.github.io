...
date: '2026-06-01'
overview: TLDR：重复的互动改变了自私的逻辑，当策略可以是友好的、报复性的、宽容的和不嫉妒的时候，合作就变得可行。
description: TLDR：重复的互动改变了自私的逻辑，当策略可以是友好的、报复性的、宽容的和不嫉妒的时候，合作就变得可行。
math: true
toc: true
relatedPosts: true
tags:
...
categories:
 - reading
lang: zh
translationKey: selfish-gene-chapter-12
canonicalSlug: selfish-gene-chapter-12
---
...
第 10 章里讲过，斤斤计较者达到一定数量后，可以互相合作并排斥骗子。第 12 章把这个思路进一步放进重复囚徒困境和进化稳定策略里。
...
## 15. 不嫉妒：不要把非 ni shish 零和博弈误当成零和博弈
...
如果重复博弈明确知道一共有 100 轮，会出现一个问题。

第 100 轮是最后一轮。

最后一轮之后没有未来，所以理性选择是背叛。

既然双方都知道第 100 轮会背叛，那么第 99 轮也变得像最后一轮。
...
这和第 10 章中“相互利他”的条件正好呼应：能识别个体，能记住过去，未来还会再次相遇。
