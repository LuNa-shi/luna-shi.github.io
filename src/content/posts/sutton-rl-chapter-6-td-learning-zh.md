---
title: Sutton RL：第 6 章 - 时间差分学习
date: '2026-05-30'
overview: TLDR：TD 通过引导当前值估计，将蒙特卡洛采样与动态编程式更新相结合，从部分经验中学习更新。
description: TLDR：TD 通过引导当前值估计，将蒙特卡洛采样与动态编程式更新相结合，从部分经验中学习更新。
math: true
toc: true
relatedPosts: true
tags:
...
categories:
 - learning
lang: zh
translationKey: sutton-rl-chapter-6-td-learning
canonicalSlug: sutton-rl-chapter-6-td-learning
---
